...
;; In addition to grading the assignment, we will also hold a single-elimination
;; Mancala tournament.  The winner of the tournament (in each class) will
;; receive a bump in his final grade.  If you want to participate in the
;; tournament, you MUST submit your project on time, no exceptions
;; whatsoever.
...
;; each other.  Imagine if Prof. Hrolenok wrote a COMPUTER-MAKE-MOVE function
...
;; (tournament 10 5
;;          #'brian-hrolenok:computer-make-move
...
;; IF you turn in your project on time AND your code compiles cleanly with
;; no warnings, AND the code runs properly, THEN you are eligible to enter
;; the contest. Entrants to the contest will compete in a single-elimination
;; tournament.
;;
...
;; 2. You may only do so on zeus.ite.gmu.edu using sbcl
